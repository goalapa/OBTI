...
public class StatDTO {
    ...
    public StatDTO(Integer statNo, LocalDate updateDate, Integer foodNo, Integer reviewCnt, float foodRate, Integer likeCnt, Integer memberAgeGroup, Integer memberGender) {
        this.statNo = statNo;
