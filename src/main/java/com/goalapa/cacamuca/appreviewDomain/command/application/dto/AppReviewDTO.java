package com.goalapa.cacamuca.appreviewDomain.command.application.dto;
...
public class AppReviewDTO {
    ...
    public AppReviewDTO(Integer appReviewNo, Integer memberNo, String memberNickName, Float appReviewRate, String appReviewContent) {
